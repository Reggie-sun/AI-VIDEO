...
from ai_video.production._hyperframes_source import (
    HyperFramesSourceError,
    capture_safe_boundary_percent as _source_capture_safe_boundary_percent,
    css_visibility_keyframes as _source_css_visibility_keyframes,
    render_source as _source_render_source,
    seconds as _seconds,
)
...
def _capture_safe_boundary_percent(
    ...
    *,
    ...
    try:
        return _source_capture_safe_boundary_percent(
            frame,
            total_frames=total_frames,
            fps=fps,
            serialized_duration=serialized_duration,
        )
    except HyperFramesSourceError as exc:
...
def _css_visibility_keyframes(
    ...
    *,
    ...
    try:
        return _source_css_visibility_keyframes(
            name,
...
def _render_with_hyperframes(
    *,
    ...
    try:
        if (
            manifest.schema_version in {"2.3", "2.4", "2.5", "2.6", "2.7", "2.8", "2.9", "2.10", "2.11", "2.12", "2.13"}
