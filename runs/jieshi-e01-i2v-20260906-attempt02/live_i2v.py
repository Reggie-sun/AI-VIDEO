...
ROOT = RUN / "production-s01-v2"
PREP = RUN / "preparation-v3"
ATTEMPT = "jieshi-e01-s01-vidu-i2v-attempt02"
EXPECTED = "cdf6a55c1d3586fbad30e5649306ef38f99d924afec645144d4daf5f9e96df9c"
    ...
    try:
        ...
        if authorization_path.exists():
            ...
            decision = PaidProviderAuthorizationDecision.create(
                ...
                opt_in_policy_receipt_id="user-jieshi-repair02-authorized-20260906",
                budget_policy_id="jieshi-s01-vidu-repair02-submit-count-one-20260906", budget_currency=profile.currency,
                ...
                egress_authorized=True, egress_policy_receipt_id="user-jieshi-repair02-first-frame-vidu-20260906",
                live_test_authorized=True, live_authorization_receipt_id="user-jieshi-repair02-authorized-20260906",
        ...
        submission = service.submit_once(attempt_id=ATTEMPT, paid_preview=preview, reservation_id="jieshi-s01-vidu-i2v-reservation02")
