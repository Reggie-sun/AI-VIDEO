...
SOURCE = RUN.parent / "jieshi-e01-i2v-20260906-attempt08" / "production-s01-v8"
...
def main():
    ...
    manifest = writer.bootstrap_initial_state(attempt_id="jieshi-s01-repair09-bootstrap", project=source.project, registry=source.registry, artifacts=artifacts)
