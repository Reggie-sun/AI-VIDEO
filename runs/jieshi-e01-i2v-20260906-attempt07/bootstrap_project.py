...
SOURCE = RUN.parent / "jieshi-e01-i2v-20260906-attempt06" / "production-s01-v6"
...
def main():
    ...
    manifest = writer.bootstrap_initial_state(attempt_id="jieshi-s01-repair07-bootstrap", project=source.project, registry=source.registry, artifacts=artifacts)
