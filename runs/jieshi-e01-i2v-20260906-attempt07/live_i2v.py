...
ATTEMPT = "jieshi-e01-s01-vidu-i2v-attempt07"
EXPECTED = "593e3c56176d80fc97e3c1bba9c10f9ef4196206b1b4ddbb887fb947ec965c11"
    ...
    try:
        ...
        if authorization_path.exists():
            ...
            decision = PaidProviderAuthorizationDecision.create(
                ...
                opt_in_policy_receipt_id="user-jieshi-repair07-authorized-20260906",
                budget_policy_id="jieshi-s01-vidu-repair07-submit-count-one-20260906", budget_currency=profile.currency,
                ...
                egress_authorized=True, egress_policy_receipt_id="user-jieshi-repair07-first-frame-vidu-20260906",
                live_test_authorized=True, live_authorization_receipt_id="user-jieshi-repair07-authorized-20260906",
        ...
        submission = service.submit_once(attempt_id=ATTEMPT, paid_preview=preview, reservation_id="jieshi-s01-vidu-i2v-reservation07")
