...
ATTEMPT = "jieshi-e01-s01-vidu-i2v-attempt04"
EXPECTED = "b66d3b87c97390eacddd01140785d1702d6f566e82881908123ac576700f55c3"
    ...
    try:
        ...
        if authorization_path.exists():
            ...
            decision = PaidProviderAuthorizationDecision.create(
                ...
                opt_in_policy_receipt_id="user-jieshi-repair04-authorized-20260906",
                budget_policy_id="jieshi-s01-vidu-repair04-submit-count-one-20260906", budget_currency=profile.currency,
                ...
                egress_authorized=True, egress_policy_receipt_id="user-jieshi-repair04-first-frame-vidu-20260906",
                live_test_authorized=True, live_authorization_receipt_id="user-jieshi-repair04-authorized-20260906",
        ...
        submission = service.submit_once(attempt_id=ATTEMPT, paid_preview=preview, reservation_id="jieshi-s01-vidu-i2v-reservation04")
