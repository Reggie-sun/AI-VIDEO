    ...
    try:
        ...
        if authorization_path.exists():
            ...
            decision = PaidProviderAuthorizationDecision.create(
                ...
                opt_in_policy_receipt_id="user-jieshi-repair05-authorized-20260906",
                budget_policy_id="jieshi-s01-vidu-repair05-submit-count-one-20260906", budget_currency=profile.currency,
                ...
                egress_authorized=True, egress_policy_receipt_id="user-jieshi-repair05-first-frame-vidu-20260906",
                live_test_authorized=True, live_authorization_receipt_id="user-jieshi-repair05-authorized-20260906",
        ...
        submission = service.submit_once(attempt_id=ATTEMPT, paid_preview=preview, reservation_id="jieshi-s01-vidu-i2v-reservation05")
