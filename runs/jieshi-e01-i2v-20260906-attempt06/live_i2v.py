...
ATTEMPT = "jieshi-e01-s01-vidu-i2v-attempt06"
EXPECTED = "94120c86894dec85b0a4dfdd0dea81f7d17dd6a42d6e1690c976be6dd7638288"
    ...
    try:
        ...
        if authorization_path.exists():
            ...
            decision = PaidProviderAuthorizationDecision.create(
                ...
                opt_in_policy_receipt_id="user-jieshi-repair06-authorized-20260906",
                budget_policy_id="jieshi-s01-vidu-repair06-submit-count-one-20260906", budget_currency=profile.currency,
                ...
                egress_authorized=True, egress_policy_receipt_id="user-jieshi-repair06-first-frame-vidu-20260906",
                live_test_authorized=True, live_authorization_receipt_id="user-jieshi-repair06-authorized-20260906",
        ...
        submission = service.submit_once(attempt_id=ATTEMPT, paid_preview=preview, reservation_id="jieshi-s01-vidu-i2v-reservation06")
