...
SOURCE = RUN.parent / "jieshi-e01-i2v-20260906-attempt07" / "production-s01-v7"
...
def main():
    ...
    manifest = writer.bootstrap_initial_state(attempt_id="jieshi-s01-repair08-bootstrap", project=source.project, registry=source.registry, artifacts=artifacts)
