...
ROOT = RUN / "production-s01-v8"
PREP = RUN / "preparation-v1"
ATTEMPT = "jieshi-e01-s01-vidu-i2v-attempt08"
EXPECTED = "65958875804c478f4094e57f6f60ebe5dd976a930e92f9a0969d6a71b9272bc7"
    ...
    try:
        ...
        if authorization_path.exists():
            ...
            decision = PaidProviderAuthorizationDecision.create(
                ...
                opt_in_policy_receipt_id="user-jieshi-repair08-authorized-20260906",
                budget_policy_id="jieshi-s01-vidu-repair08-submit-count-one-20260906", budget_currency=profile.currency,
                ...
                egress_authorized=True, egress_policy_receipt_id="user-jieshi-repair08-first-frame-vidu-20260906",
                live_test_authorized=True, live_authorization_receipt_id="user-jieshi-repair08-authorized-20260906",
        ...
        submission = service.submit_once(attempt_id=ATTEMPT, paid_preview=preview, reservation_id="jieshi-s01-vidu-i2v-reservation08")
