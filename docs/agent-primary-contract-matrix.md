...
- P5 已在当前 feature branch 实现 immutable graph、Manifest 2.3 lifecycle、precise resolver 与 explicit recovery，并以 deterministic mutation matrix 完成 focused acceptance；尚未 merge/push/release。P5 不授权 P6-P9，也不改变 Legacy CLI/Manifest/layout。
