...
本文记录 Shot Continuity Phase P1 的三个 candidate-neutral checkpoint：M0 request-level
pre-submit identity guard、C4对model-native exact frame-count timing的provider-neutral表达，以及
live node-schema materialization与execution-stack reseal closure。
