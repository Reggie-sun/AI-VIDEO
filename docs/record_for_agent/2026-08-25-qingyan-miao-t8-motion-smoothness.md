...
本文记录青颜苗家女孩广告在继续制作前的两次 Local MiniMax H3 T8 `Stock20`
development experiment。用户明确暂时取消 9:16 门槛，优先验证真实人物运动是否流畅；
因此本轮只验证横屏单镜头行走，不生成产品喷洒镜头，也不把结果扩展为完整广告、
Production candidate、P6 或 Final Acceptance。
